...
/media/morpheus/sagar/BUDDHA/TOGA_new/make_lastz_chains/make_chains.py Sarcophilus_harrisii $species_name Sarcophilus_harrisii-"$chr_id".fa "$species_name".30kbslop.fasta --chaining_memory 40 --project_dir chain_Sarcophilus_harrisii_"$species_name" --kt 
