      seqfile = 19spCUZD1.aln.faa * sequence data filename
     treefile = Pseudocheirus_occidentalis.nwk      * tree structure file name
      outfile = Pseudocheirus_occidentalis_F1x4_bneutral.out        * main result file name
